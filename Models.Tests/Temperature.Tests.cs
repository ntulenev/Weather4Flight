...
{
    [Fact(DisplayName = "Given temperature value below absolute zero, when creating temperature object, then should throw ArgumentException")]
    [Trait("Category", "Unit")]
    ...
    [Theory(DisplayName = "Given temperature value, when getting temperature category, then should return correct category")]
    [Trait("Category", "Unit")]
    ...
    public void GivenTemperatureValue_WhenGettingTemperatureCategory_ThenShouldReturnCorrectCategory(decimal value, TemperatureCategory expectedCategory)
    {
        // Arrange
